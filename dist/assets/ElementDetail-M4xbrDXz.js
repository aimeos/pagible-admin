import{_ as C,y as v,a9 as S,g as b,w as l,aw as M,o as h,a as s,ax as O,ai as B,aa as k,ab as I,p as V,t as o,ah as $,a_ as U,b as n,c as y,F as E,C as H,i as D,P as j,a$ as F,b0 as J,R as z,r as g,u as T,V as w,O as K,H as Z,a8 as W,ak as G,au as Q,as as X,at as Y,T as x,av as _,m as f,n as p,j as ee,aR as te,q as ae,b1 as P,am as ie,f as se,b2 as le,b3 as A,b4 as ne,b5 as L}from"./index-LaBj0mT4.js";import{F as re,H as de,C as oe,A as ue,a as me,h as he,s as fe}from"./echo-Kgu0xvIu.js";import{l as ge}from"./utils-C-DQD3QK.js";import{a as be,w as pe}from"./ai-CHvsZfvz.js";import{F as ve,G as ye,J as Ve,K as ce,L as we,M as Ee}from"./mdi-Be4FI9db.js";const De={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{user:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.user.can("element:view")||this.$apollo.query({query:v`
              query ($id: ID!) {
                element(id: $id) {
                  id
                  bypages {
