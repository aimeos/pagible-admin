import{Cn as e,J as t,K as n,Ut as r,Y as i,nt as a}from"./charts-jDwLkx1m.js";import{s as o}from"./graphql-BP2ngTk6.js";import{t as s}from"./VIcon-C3jBxLcD.js";import{Dn as c,b as l,bt as u,jn as d,nn as f,p,qn as m,tr as h,vn as g}from"./index-C5owmVeV.js";var _=o`
...
`+e,`error`),this.$log(`FileDetailItemVideo::uploadCover(): Error uploading video cover`,e)}).finally(()=>{this.loading.cover=!1})}}},b={class:`editor-container`},x=[`src`],S={key:0,class:`toolbar`},C=[`src`,`alt`],w={key:1};function T(o,c,l,u,d,f){return r(),i(`div`,b,[n(`video`,{ref:`video`,src:u.fileurl(l.item),crossorigin:`anonymous`,class:`element`,controls:``},null,8,x),l.readonly?t(``,!0):(r(),i(`div`,S,[Object.values(l.item.previews).length?(r(),i(`img`,{key:0,class:`video-preview`,src:u.fileurl(l.item,Object.values(l.item.previews).shift()),alt:l.item.name,onClick:c[0]||=e=>f.removeCover()},null,8,C)):(r(),i(`div`,w,[a(p,{icon:u.mdiTooltipImage,loading:d.loading.cover,title:o.$gettext(`Use as cover image`),class:`btn-cover-use`,onClick:c[1]||=e=>f.addCover()},null,8,[`icon`,`loading`,`title`]),a(p,{icon:``,class:`btn-cover-upload`,loading:d.loading.cover,title:o.$gettext(`Upload cover image`),onClick:c[3]||=e=>o.$refs.coverInput.click()},{default:e(()=>[a(s,{icon:u.mdiImagePlus},null,8,[`icon`]),n(`input`,{ref:`coverInput`,type:`file`,class:`cover-input`,onChange:c[2]||=e=>f.uploadCover(e)},null,544)]),_:1},8,[`loading`,`title`])]))]))])}var E=l(y,[[`render`,T],[`__scopeId`,`data-v-00bc8d8f`]]);export{E as default};