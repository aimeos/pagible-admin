import{_ as D,y as g,a9 as S,g as v,w as s,aw as q,o as h,a as i,ax as M,ai as N,aa as k,ab as C,p as y,t as d,ah as $,a_ as U,b as r,c as b,F as E,C as T,i as H,P as R,a$ as j,b0 as F,R as J,r as p,u as I,V as w,O as K,H as Z,a8 as W,ak as z,au as G,as as Q,at as X,T as Y,av as x,m as f,n as V,j as _,aR as ee,q as te,b1 as P,am as ae,f as ie,b2 as se,b3 as A,b4 as le,b5 as L}from"./index-UmJw0nZM.js";import{F as re,H as ne,A as de}from"./ElementListItems-CrOY-hqv.js";import{l as oe}from"./utils-B0CWr03j.js";import{a as ue,w as me}from"./ai-DAMocL_3.js";import{F as he,G as fe,J as ge,K as be,L as pe}from"./mdi-DA9g8ejv.js";const ve={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{user:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.user.can("element:view")||this.$apollo.query({query:g`
              query ($id: ID!) {
                element(id: $id) {
                  id
                  bypages {
