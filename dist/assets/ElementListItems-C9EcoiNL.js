import{$t as e,Cn as t,D as n,Hn as r,J as i,K as a,P as o,R as s,T as c,Tn as l,Ut as u,Y as d,Yt as f,Zt as p,kt as m,nt as h,q as g,sr as _,tt as v,ur as y}from"./charts-PGn4BQj3.js";import{s as b}from"./graphql-C4Y4hVTz.js";import{o as x,t as S}from"./VList-CCvgkXmu.js";import{t as ee}from"./VIcon-c6Y80uEN.js";import{$ as C,At as w,Dn as T,Fn as E,Gn as D,H as O,Ht as k,In as A,Lt as j,Pn as M,Q as N,Qn as P,Sn as te,U as ne,Vn as F,Vt as I,b as L,gn as R,jn as z,m as B,nt as V,o as H,r as U,s as W,t as G,tt as K,vn as q,yn as J,zt as Y}from"./index-CqZUgsl4.js";import{t as X}from"./VDivider-Lom6Ey3A.js";import{t as Z}from"./EditBulkDialog-vwlkfQ9P.js";import{t as Q}from"./VCheckboxBtn-DioJh39x.js";import{t as re}from"./VTextField-CMdMDeDP.js";import{t as ie}from"./ListSort-BJ2Sx5PC.js";import{a as ae,r as oe}from"./files-C03OThty.js";import{t as se}from"./VPagination-D9jpVvdP.js";import{t as ce}from"./SchemaItems-bX0EKLFR.js";var le=b`
...
`)},toggle(){this.checked=this.checked.size>0?new Set:new Set(this.items.map(e=>e.id))},toggleCheck(e){let t=new Set(this.checked);t.has(e.id)?t.delete(e.id):t.add(e.id),this.checked=t}},watch:{"changes.changed.element"(){this.sync()},filter:{deep:!0,handler(){this.search()}},term(){this.searchd()},page(){this.search()},sort:{deep:!0,handler(){this.user.saveData(`element`,`sort`,this.sort),this.search()}}}},ve={class:`header`},ye={class:`bulk`},be={class:`btn-actions`},xe={class:`search`},Se={class:`layout`},Ce={class:`actions`},we={class:`btn-actions`},Te=[`onClick`,`title`],Ee={class:`item-text`},De={class:`item-head`},$={key:0,class:`item-lang`},Oe={class:`item-title`},ke={class:`item-type item-subtitle`},Ae={class:`item-aux`},je={class:`item-editor`},Me={class:`item-modified item-subtitle`},Ne={key:0,class:`loading`},Pe={key:1,class:`notfound`},Fe={key:3,class:`btn-group`};function Ie(r,b,C,w,T,E){let D=p(`ListSort`),O=p(`SchemaItems`),k=p(`EditBulkDialog`);return u(),d(o,null,[a(`div`,ve,[a(`div`,ye,[h(Q,{"model-value":T.checked.size>0,onClick:b[0]||=n(e=>E.toggle(),[`stop`]),"aria-label":r.$gettext(`Toggle selection`)},null,8,[`model-value`,`aria-label`]),a(`span`,be,[(u(),g(e(r.$vuetify.display.xs?`v-dialog`:`v-menu`),{"aria-label":r.$gettext(`Actions`),modelValue:T.actions,"onUpdate:modelValue":b[8]||=e=>T.actions=e,transition:`scale-transition`,location:`end center`,"max-width":`300`},{activator:t(({props:e})=>[h(B,m(e,{disabled:!E.isChecked||C.embed||!w.user.can(`element:add`),title:r.$gettext(`Actions`),icon:w.mdiDotsVertical,variant:`text`}),null,16,[`disabled`,`title`,`icon`])]),default:t(()=>[h(H,null,{default:t(()=>[h(G,{density:`compact`},{default:t(()=>[h(U,null,{default:t(()=>[v(y(r.$gettext(`Actions`)),1)]),_:1}),h(B,{icon:w.mdiClose,"aria-label":r.$gettext(`Close`),onClick:b[1]||=e=>T.actions=!1},null,8,[`icon`,`aria-label`])]),_:1}),h(S,{onClick:b[7]||=e=>T.actions=!1},{default:t(()=>[l(h(x,null,{default:t(()=>[h(B,{"prepend-icon":w.mdiPublish,variant:`text`,onClick:b[2]||=e=>E.publish()},{default:t(()=>[v(y(r.$gettext(`Publish`)),1)]),_:1},8,[`prepend-icon`])]),_:1},512),[[c,E.isChecked&&w.user.can(`element:publish`)]]),l(h(x,null,{default:t(()=>[h(B,{"prepend-icon":w.mdiPencil,variant:`text`,onClick:b[3]||=e=>E.edit()},{default:t(()=>[v(y(r.$gettext(`Edit properties`)),1)]),_:1},8,[`prepend-icon`])]),_:1},512),[[c,E.isChecked&&w.user.can(`element:save`)]]),l(h(x,null,{default:t(()=>[h(B,{"prepend-icon":w.mdiDelete,variant:`text`,onClick:b[4]||=e=>E.drop()},{default:t(()=>[v(y(r.$gettext(`Delete`)),1)]),_:1},8,[`prepend-icon`])]),_:1},512),[[c,E.canTrash&&w.user.can(`element:drop`)]]),l(h(x,null,{default:t(()=>[h(B,{"prepend-icon":w.mdiDeleteRestore,variant:`text`,onClick:b[5]||=e=>E.keep()},{default:t(()=>[v(y(r.$gettext(`Restore`)),1)]),_:1},8,[`prepend-icon`])]),_:1},512),[[c,E.isTrashed&&w.user.can(`element:keep`)]]),l(h(x,null,{default:t(()=>[h(B,{"prepend-icon":w.mdiDeleteForever,variant:`text`,onClick:b[6]||=e=>E.purge()},{default:t(()=>[v(y(r.$gettext(`Purge`)),1)]),_:1},8,[`prepend-icon`])]),_:1},512),[[c,E.isChecked&&w.user.can(`element:purge`)]])]),_:1})]),_:1})]),_:1},8,[`aria-label`,`modelValue`]))]),!this.embed&&this.user.can(`element:add`)?(u(),g(B,{key:0,onClick:b[9]||=e=>T.vschemas=!0,title:r.$gettext(`Add element`),disabled:T.loading,icon:w.mdiPlus,class:`btn-add`,color:`primary`,variant:`tonal`},null,8,[`title`,`disabled`,`icon`])):i(``,!0)]),a(`div`,xe,[h(re,{modelValue:T.term,"onUpdate:modelValue":b[10]||=e=>T.term=e,"prepend-inner-icon":w.mdiMagnify,variant:`underlined`,label:r.$gettext(`Search for`),"hide-details":``,clearable:``},null,8,[`modelValue`,`prepend-inner-icon`,`label`])]),a(`div`,Se,[T.outdated?(u(),g(B,{key:0,onClick:b[11]||=e=>E.reload(),"prepend-icon":w.mdiRefresh,title:r.$gettext(`Updated by another user`),color:`primary`,variant:`tonal`,size:`small`,rounded:`lg`,class:`btn-outdated`},{default:t(()=>[v(y(r.$gettext(`Refresh`)),1)]),_:1},8,[`prepend-icon`,`title`])):i(``,!0),h(B,{onClick:b[12]||=e=>E.reload(),title:r.$gettext(`Reload elements`),icon:w.mdiRefresh,class:`btn-reload`,variant:`text`},null,8,[`title`,`icon`]),h(D,{modelValue:T.sort,"onUpdate:modelValue":b[13]||=e=>T.sort=e,options:w.sortOptions},null,8,[`modelValue`,`options`])])]),h(S,{class:`items`},{default:t(()=>[(u(!0),d(o,null,f(T.items,(o,s)=>(u(),g(x,{key:s},{default:t(()=>[a(`div`,Ce,[h(Q,{"model-value":T.checked.has(o.id),"onUpdate:modelValue":e=>E.toggleCheck(o),class:_([{draft:!o.published},`item-check`])},null,8,[`model-value`,`onUpdate:modelValue`,`class`]),a(`span`,we,[(u(),g(e(r.$vuetify.display.xs?`v-dialog`:`v-menu`),{"aria-label":r.$gettext(`Actions`),modelValue:T.menu[s],"onUpdate:modelValue":e=>T.menu[s]=e,transition:`scale-transition`,location:`end center`,"max-width":`300`},{activator:t(({props:e})=>[h(B,m({ref_for:!0},e,{title:r.$gettext(`Actions`),icon:w.mdiDotsVertical,variant:`text`}),null,16,[`title`,`icon`])]),default:t(()=>[h(H,null,{default:t(()=>[h(G,{density:`compact`},{default:t(()=>[h(U,null,{default:t(()=>[v(y(r.$gettext(`Actions`)),1)]),_:1}),h(B,{icon:w.mdiClose,"aria-label":r.$gettext(`Close`),onClick:e=>T.menu[s]=!1},null,8,[`icon`,`aria-label`,`onClick`])]),_:2},1024),h(S,{onClick:e=>T.menu[s]=!1},{default:t(()=>[l(h(x,null,{default:t(()=>[h(B,{"prepend-icon":w.mdiPublish,variant:`text`,onClick:e=>E.publish(o)},{default:t(()=>[v(y(r.$gettext(`Publish`)),1)]),_:1},8,[`prepend-icon`,`onClick`])]),_:2},1536),[[c,!o.deleted_at&&!o.published&&this.user.can(`element:publish`)]]),!o.deleted_at&&!o.published&&w.user.can(`element:publish`)&&w.user.can(`element:save`)?(u(),g(X,{key:0})):i(``,!0),w.user.can(`element:save`)?(u(),g(x,{key:1},{default:t(()=>[h(B,{"prepend-icon":w.mdiPencil,variant:`text`,onClick:e=>E.edit(o)},{default:t(()=>[v(y(r.$gettext(`Edit properties`)),1)]),_:1},8,[`prepend-icon`,`onClick`])]),_:2},1024)):i(``,!0),w.user.can(`element:save`)?(u(),g(X,{key:2})):i(``,!0),!o.deleted_at&&this.user.can(`element:drop`)?(u(),g(x,{key:3},{default:t(()=>[h(B,{"prepend-icon":w.mdiDelete,variant:`text`,onClick:e=>E.drop(o)},{default:t(()=>[v(y(r.$gettext(`Delete`)),1)]),_:1},8,[`prepend-icon`,`onClick`])]),_:2},1024)):i(``,!0),o.deleted_at&&this.user.can(`element:keep`)?(u(),g(x,{key:4},{default:t(()=>[h(B,{"prepend-icon":w.mdiDeleteRestore,variant:`text`,onClick:e=>E.keep(o)},{default:t(()=>[v(y(r.$gettext(`Restore`)),1)]),_:1},8,[`prepend-icon`,`onClick`])]),_:2},1024)):i(``,!0),this.user.can(`element:purge`)?(u(),g(x,{key:5},{default:t(()=>[h(B,{"prepend-icon":w.mdiDeleteForever,variant:`text`,onClick:e=>E.purge(o)},{default:t(()=>[v(y(r.$gettext(`Purge`)),1)]),_:1},8,[`prepend-icon`,`onClick`])]),_:2},1024)):i(``,!0)]),_:2},1032,[`onClick`])]),_:2},1024)]),_:2},1032,[`aria-label`,`modelValue`,`onUpdate:modelValue`]))])]),a(`a`,{href:`#`,class:_([`item-content`,{trashed:o.deleted_at}]),onClick:n(e=>r.$emit(`select`,o),[`prevent`]),title:E.title(o)},[a(`div`,Ee,[a(`div`,De,[o.lang?(u(),d(`span`,$,y(o.lang),1)):i(``,!0),o.publish_at?(u(),g(ee,{key:1,class:`publish-at`,icon:w.mdiClockOutline},null,8,[`icon`])):i(``,!0),a(`span`,Oe,y(o.name||r.$gettext(`New`)),1)]),a(`div`,ke,y(o.type),1)]),a(`div`,Ae,[a(`div`,je,y(o.editor),1),a(`div`,Me,y(new Date(o.updated_at).toLocaleString()),1)])],10,Te)]),_:2},1024))),128))]),_:1}),T.loading?(u(),d(`p`,Ne,[v(y(r.$gettext(`Loading`))+` `,1),b[20]||=a(`svg`,{class:`spinner`,width:`32`,height:`32`,fill:`currentColor`,viewBox:`0 0 24 24`,xmlns:`http://www.w3.org/2000/svg`},[a(`circle`,{class:`spin1`,cx:`4`,cy:`12`,r:`3`}),a(`circle`,{class:`spin1 spin2`,cx:`12`,cy:`12`,r:`3`}),a(`circle`,{class:`spin1 spin3`,cx:`20`,cy:`12`,r:`3`})],-1)])):i(``,!0),!T.loading&&!T.items.length?(u(),d(`p`,Pe,y(r.$gettext(`No entries found`)),1)):i(``,!0),T.last>1?(u(),g(se,{key:2,modelValue:T.page,"onUpdate:modelValue":b[14]||=e=>T.page=e,length:T.last},null,8,[`modelValue`,`length`])):i(``,!0),!this.embed&&this.user.can(`element:add`)?(u(),d(`div`,Fe,[h(B,{onClick:b[15]||=e=>T.vschemas=!0,title:r.$gettext(`Add element`),disabled:T.loading,icon:w.mdiPlus,class:`btn-add`,color:`primary`,variant:`tonal`},null,8,[`title`,`disabled`,`icon`])])):i(``,!0),(u(),g(s,{to:`body`},[h(R,{modelValue:T.vschemas,"onUpdate:modelValue":b[17]||=e=>T.vschemas=e,onAfterLeave:b[18]||=e=>T.vschemas=!1,scrollable:``,width:`auto`},{default:t(()=>[h(H,null,{default:t(()=>[h(W,null,{default:t(()=>[h(O,{type:`content`,onAdd:b[16]||=e=>E.add(e)})]),_:1})]),_:1})]),_:1},8,[`modelValue`])])),h(k,{modelValue:T.editDialog,"onUpdate:modelValue":b[19]||=e=>T.editDialog=e,count:T.editIds.length,onApply:E.save},null,8,[`modelValue`,`count`,`onApply`])],64)}var Le=L(_e,[[`render`,Ie],[`__scopeId`,`data-v-2703f488`]]);export{Le as t};