import{g as u}from"./graphql-B4q3OoAp.js";import{_ as p,i as m,j as f,K as v,F as w,E as _,bw as $,bx as I,H as E}from"./index-C53sJ6sJ.js";import{j as d,c as l,k as h,b as c,e as x,q as y}from"./tree-BneADi2F.js";import"./shared-C1gvLhAf.js";const g=u`
...
`+t,"error"),this.$log("FileDetailItemVideo::uploadCover(): Error uploading video cover",t)}).finally(()=>{this.loading.cover=!1})}}},F={class:"editor-container"},V=["src"],k={key:0,class:"toolbar"},P=["src","alt"],B={key:1};function U(e,i,t,a,r,s){return d(),l("div",F,[h("video",{ref:"video",src:a.url(t.item.path),crossorigin:"anonymous",class:"element",controls:""},null,8,V),t.readonly?y("",!0):(d(),l("div",k,[Object.values(t.item.previews).length?(d(),l("img",{key:0,class:"video-preview",src:a.url(Object.values(t.item.previews).shift()),alt:t.item.name,onClick:i[0]||(i[0]=o=>s.removeCover())},null,8,P)):(d(),l("div",B,[c(m,{icon:a.mdiTooltipImage,loading:r.loading.cover,title:e.$gettext("Use as cover image"),class:"btn-cover-use",onClick:i[1]||(i[1]=o=>s.addCover())},null,8,["icon","loading","title"]),c(m,{icon:"",class:"btn-cover-upload",loading:r.loading.cover,title:e.$gettext("Upload cover image"),onClick:i[3]||(i[3]=o=>e.$refs.coverInput.click())},{default:x(()=>[c(f,{icon:a.mdiImagePlus},null,8,["icon"]),h("input",{ref:"coverInput",type:"file",class:"cover-input",onChange:i[2]||(i[2]=o=>s.uploadCover(o))},null,544)]),_:1},8,["loading","title"])]))]))])}const W=p(b,[["render",U],["__scopeId","data-v-f3ae0c77"]]);export{W as default};
