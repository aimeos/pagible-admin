import{d as u}from"./graphql-C9B-AmXv.js";import{G as c,H as m,t as l,J as f}from"./index-Dj2h6P6L.js";import{toMp3 as d,transcription as g}from"./audio-CvQuggF0.js";import{u as p}from"./utils-GbLosTlN.js";import"./graphql-upload-BJJQ6Vjw.js";import"./tree-BnNcOl7f.js";const $=u`
...
`+i,"error"),console.error("useAi::translate(): Error translating texts",i)}):Promise.reject(new Error("Target language is required")):Promise.resolve([])}function U(e,n=[],o=[]){const a=c(),r=m(),{$gettext:s}=l;if(!a.can("text:write")){r.add(s("Permission denied"),"error");return}return e=String(e).trim(),e?(Array.isArray(n)||(n=[n]),n.push("Only return the requested data without any additional information"),f.mutate({mutation:h,variables:{prompt:e,context:n.filter(t=>!!t).join(`
