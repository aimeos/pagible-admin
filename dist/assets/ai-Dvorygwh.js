import{a8 as d,aj as m,P as g,ak as p,y as h}from"./index-CvKXFUeT.js";import{u as $}from"./utils-CgpzX5Qm.js";function b(){let e,r,a,o=!1;const n=[];return{async start(){if(o)return;o=!0;const s=new Blob([`
...
`+t,"error"),console.error("useAi::write(): Error generating text",t)})):(n.add(s("Prompt is required for generating text"),"error"),Promise.resolve(""))}export{U as a,b as r,B as t,P as w};
