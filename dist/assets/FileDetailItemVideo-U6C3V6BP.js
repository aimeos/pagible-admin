import{Cn as e,J as t,K as n,Ut as r,Y as i,nt as a}from"./charts-D3TmX40N.js";import{s as o}from"./graphql-REqfkFwC.js";import{t as s}from"./VIcon-CaEd7GYo.js";import{An as c,En as l,Un as u,Zn as d,b as f,m as p,rn as m,xt as h}from"./index-Bc_wvyDW.js";var g=o`
...
`+e,`error`),this.$log(`FileDetailItemVideo::uploadCover(): Error uploading video cover`,e)}).finally(()=>{this.loading.cover=!1})}}},y={class:`editor-container`},b=[`src`],x={key:0,class:`toolbar`},S=[`src`,`alt`],C={key:1};function w(o,c,l,u,d,f){return r(),i(`div`,y,[n(`video`,{ref:`video`,src:u.fileurl(l.item),crossorigin:`anonymous`,class:`element`,controls:``},null,8,b),l.readonly?t(``,!0):(r(),i(`div`,x,[Object.values(l.item.previews).length?(r(),i(`img`,{key:0,class:`video-preview`,src:u.fileurl(l.item,Object.values(l.item.previews).shift()),alt:l.item.name,onClick:c[0]||=e=>f.removeCover()},null,8,S)):(r(),i(`div`,C,[a(p,{icon:u.mdiTooltipImage,loading:d.loading.cover,title:o.$gettext(`Use as cover image`),class:`btn-cover-use`,onClick:c[1]||=e=>f.addCover()},null,8,[`icon`,`loading`,`title`]),a(p,{icon:``,class:`btn-cover-upload`,loading:d.loading.cover,title:o.$gettext(`Upload cover image`),onClick:c[3]||=e=>o.$refs.coverInput.click()},{default:e(()=>[a(s,{icon:u.mdiImagePlus},null,8,[`icon`]),n(`input`,{ref:`coverInput`,type:`file`,class:`cover-input`,onChange:c[2]||=e=>f.uploadCover(e)},null,544)]),_:1},8,[`loading`,`title`])]))]))])}var T=f(v,[[`render`,w],[`__scopeId`,`data-v-03101af9`]]);export{T as default};