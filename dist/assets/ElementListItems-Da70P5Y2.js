import{m as A,k,q as u,l,z as S,c as f,p as a,r as w,A as v,B as m,C as o,T as N,F as $,j as R,b as c,I as _,W as x,D,R as M,x as I}from"./tree-BnNcOl7f.js";import{d as C}from"./graphql-C9B-AmXv.js";import{_ as U,H as B,G as O,as as F,al as z,at as j,au as q,av as H,aw as G,ax as J,ay as Q,X as W,ak as Y,F as K,g as X,a as h,E as Z,A as y,B as P,C as T,az as ee,D as te}from"./index-Dj2h6P6L.js";import{S as se}from"./SchemaItems-DLeZaXuE.js";import{f as ie,d as le}from"./utils-GbLosTlN.js";import{V as L}from"./VCheckboxBtn-CiDRwsuv.js";import{V as ae}from"./VTextField-DjrKf5qa.js";import{V as ne}from"./VSheet-CjN3gwap.js";import{V,a as p}from"./VList-DJD9af_D.js";import{V as re}from"./VPagination-CNHFTb0z.js";const de=C`
...
`,pe={components:{SchemaItems:se},props:{embed:{type:Boolean,default:!1},filter:{type:Object,default:()=>({})}},emits:["select"],data(){return{items:[],menu:[],checked:new Set,term:"",sort:this.user.getData("element","sort")||{column:"ID",order:"DESC"},page:1,last:1,limit:100,vschemas:!1,actions:!1,loading:!0,trash:!1}},setup(){const t=B();return{user:O(),messages:t,mdiDotsVertical:X,mdiClose:K,mdiPublish:Y,mdiDelete:W,mdiDeleteRestore:Q,mdiDeleteForever:J,mdiPlus:G,mdiMagnify:H,mdiMenuDown:q,mdiSort:j,mdiClockOutline:z,mdiRefresh:F,debounce:le}},created(){this.search(),this.searchd=this.debounce(this.search,500)},beforeUnmount(){this.items=null,this.menu=null,this.checked=null},computed:{canTrash(){return this.items.some(t=>this.checked.has(t.id)&&!t.deleted_at)},isChecked(){return this.checked.size>0},isTrashed(){return this.items.some(t=>this.checked.has(t.id)&&t.deleted_at)}},methods:{add(t){if(this.embed||!this.user.can("element:add")){this.messages.add(this.$gettext("Permission denied"),"error");return}return this.$apollo.mutate({mutation:de,variables:{input:{type:t.type,name:"",data:"{}"}}}).then(e=>{if(e.errors)throw e.errors;const s=e.data?.addElement||{};return s.data=ie(s.data),s.published=!0,this.vschemas=!1,this.items.unshift(s),this.$emit("select",s),this.invalidate(),s}).catch(e=>{this.$log("ElementListItems::add(): Error adding shared element",e)})},drop(t){if(!this.user.can("element:drop")){this.messages.add(this.$gettext("Permission denied"),"error");return}const e=t?[t]:this.items.filter(s=>this.checked.has(s.id));e.length&&this.$apollo.mutate({mutation:oe,variables:{id:e.map(s=>s.id)}}).then(s=>{if(s.errors)throw s.errors;this.invalidate(),this.search()}).catch(s=>{this.messages.add(this.$gettext("Error trashing shared element")+`:
