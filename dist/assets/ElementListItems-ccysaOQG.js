import{A as e,B as t,Bt as n,H as r,K as i,Lt as a,W as o,c as s,g as c,h as l,lt as u,m as d,nt as f,o as p,p as m,rt as h,v as g,y as _}from"./charts-BcPwWJ4d.js";import{in as v,nn as y}from"./dimensions-CksMkI0c.js";import{r as b}from"./graphql-CcslCevZ.js";import{o as x,t as S}from"./VList-DWXj_D-Q.js";import{t as C}from"./VIcon-B4YmdphC.js";import{At as w,Bt as T,Ct as E,Dn as D,Et as O,Fn as k,J as A,Mt as j,Nn as M,Nt as ee,On as te,Pt as ne,Q as N,R as P,Sn as F,Tn as I,Vn as L,Y as R,Z as z,_n as B,an as V,b as H,kn as U,m as W,o as G,on as K,r as q,s as J,t as Y,z as X}from"./index-CSE6bO8v.js";import{t as Z}from"./EditBulkDialog-XXAsnuSy.js";import{t as Q}from"./VCheckboxBtn-DzkBCgXv.js";import{t as re}from"./VTextField-B-n0fi1G.js";import{t as ie}from"./VPagination-wg0jTud5.js";import{t as ae}from"./SchemaItems-BSSi67ZE.js";var oe=b`
...
`)},toggle(){this.checked.size>0?this.checked=new Set:this.checked=new Set(this.items.map(e=>e.id))},toggleCheck(e){let t=new Set(this.checked);t.has(e.id)?t.delete(e.id):t.add(e.id),this.checked=t}},watch:{"changes.changed.element"(){this.sync()},filter:{deep:!0,handler(){this.search()}},term(){this.searchd()},page(){this.search()},sort:{deep:!0,handler(){this.user.saveData(`element`,`sort`,this.sort),this.search()}}}},me={class:`header`},he={class:`bulk`},ge={class:`btn-actions`},_e={class:`search`},ve={class:`layout`},ye={class:`btn-sort`},be={class:`actions`},xe={class:`btn-actions`},Se=[`onClick`,`title`],Ce={class:`item-text`},we={class:`item-head`},Te={key:0,class:`item-lang`},Ee={class:`item-title`},De={class:`item-type item-subtitle`},$={class:`item-aux`},Oe={class:`item-editor`},ke={class:`item-modified item-subtitle`},Ae={key:0,class:`loading`},je={key:1,class:`notfound`},Me={key:3,class:`btn-group`};function Ne(u,b,w,T,E,D){let O=o(`SchemaItems`),k=o(`EditBulkDialog`);return t(),c(p,null,[m(`div`,me,[m(`div`,he,[_(Q,{"model-value":E.checked.size>0,onClick:b[0]||=v(e=>D.toggle(),[`stop`]),"aria-label":u.$gettext(`Toggle selection`)},null,8,[`model-value`,`aria-label`]),m(`span`,ge,[(t(),d(i(u.$vuetify.display.xs?`v-dialog`:`v-menu`),{"aria-label":u.$gettext(`Actions`),modelValue:E.actions,"onUpdate:modelValue":b[8]||=e=>E.actions=e,transition:`scale-transition`,location:`end center`,"max-width":`300`},{activator:f(({props:t})=>[_(W,e(t,{disabled:!D.isChecked||w.embed||!T.user.can(`element:add`),title:u.$gettext(`Actions`),icon:T.mdiDotsVertical,variant:`text`}),null,16,[`disabled`,`title`,`icon`])]),default:f(()=>[_(G,null,{default:f(()=>[_(Y,{density:`compact`},{default:f(()=>[_(q,null,{default:f(()=>[g(n(u.$gettext(`Actions`)),1)]),_:1}),_(W,{icon:T.mdiClose,"aria-label":u.$gettext(`Close`),onClick:b[1]||=e=>E.actions=!1},null,8,[`icon`,`aria-label`])]),_:1}),_(S,{onClick:b[7]||=e=>E.actions=!1},{default:f(()=>[h(_(x,null,{default:f(()=>[_(W,{"prepend-icon":T.mdiPublish,variant:`text`,onClick:b[2]||=e=>D.publish()},{default:f(()=>[g(n(u.$gettext(`Publish`)),1)]),_:1},8,[`prepend-icon`])]),_:1},512),[[y,D.isChecked&&T.user.can(`element:publish`)]]),h(_(x,null,{default:f(()=>[_(W,{"prepend-icon":T.mdiPencil,variant:`text`,onClick:b[3]||=e=>D.edit()},{default:f(()=>[g(n(u.$gettext(`Edit properties`)),1)]),_:1},8,[`prepend-icon`])]),_:1},512),[[y,D.isChecked&&T.user.can(`element:save`)]]),h(_(x,null,{default:f(()=>[_(W,{"prepend-icon":T.mdiDelete,variant:`text`,onClick:b[4]||=e=>D.drop()},{default:f(()=>[g(n(u.$gettext(`Delete`)),1)]),_:1},8,[`prepend-icon`])]),_:1},512),[[y,D.canTrash&&T.user.can(`element:drop`)]]),h(_(x,null,{default:f(()=>[_(W,{"prepend-icon":T.mdiDeleteRestore,variant:`text`,onClick:b[5]||=e=>D.keep()},{default:f(()=>[g(n(u.$gettext(`Restore`)),1)]),_:1},8,[`prepend-icon`])]),_:1},512),[[y,D.isTrashed&&T.user.can(`element:keep`)]]),h(_(x,null,{default:f(()=>[_(W,{"prepend-icon":T.mdiDeleteForever,variant:`text`,onClick:b[6]||=e=>D.purge()},{default:f(()=>[g(n(u.$gettext(`Purge`)),1)]),_:1},8,[`prepend-icon`])]),_:1},512),[[y,D.isChecked&&T.user.can(`element:purge`)]])]),_:1})]),_:1})]),_:1},8,[`aria-label`,`modelValue`]))]),!this.embed&&this.user.can(`element:add`)?(t(),d(W,{key:0,onClick:b[9]||=e=>E.vschemas=!0,title:u.$gettext(`Add element`),disabled:E.loading,icon:T.mdiPlus,class:`btn-add`,color:`primary`,variant:`tonal`},null,8,[`title`,`disabled`,`icon`])):l(``,!0)]),m(`div`,_e,[_(re,{modelValue:E.term,"onUpdate:modelValue":b[10]||=e=>E.term=e,"prepend-inner-icon":T.mdiMagnify,variant:`underlined`,label:u.$gettext(`Search for`),"hide-details":``,clearable:``},null,8,[`modelValue`,`prepend-inner-icon`,`label`])]),m(`div`,ve,[E.outdated?(t(),d(W,{key:0,onClick:b[11]||=e=>D.reload(),"prepend-icon":T.mdiRefresh,title:u.$gettext(`Updated by another user`),color:`primary`,variant:`tonal`,size:`small`,rounded:`lg`,class:`btn-outdated`},{default:f(()=>[g(n(u.$gettext(`Refresh`)),1)]),_:1},8,[`prepend-icon`,`title`])):l(``,!0),_(W,{onClick:b[12]||=e=>D.reload(),title:u.$gettext(`Reload elements`),icon:T.mdiRefresh,class:`btn-reload`,variant:`text`},null,8,[`title`,`icon`]),m(`span`,ye,[_(V,null,{activator:f(({props:t})=>[_(W,e(t,{title:u.$gettext(`Sort by`),"append-icon":T.mdiMenuDown,"prepend-icon":T.mdiSort,variant:`text`}),{default:f(()=>[g(n(E.sort?.column===`ID`?E.sort?.order===`DESC`?u.$gettext(`latest`):u.$gettext(`oldest`):E.sort?.column||``),1)]),_:1},16,[`title`,`append-icon`,`prepend-icon`])]),default:f(()=>[_(S,null,{default:f(()=>[_(x,null,{default:f(()=>[_(W,{variant:`text`,onClick:b[13]||=e=>D.setSort(`ID`,`DESC`)},{default:f(()=>[g(n(u.$gettext(`latest`)),1)]),_:1})]),_:1}),_(x,null,{default:f(()=>[_(W,{variant:`text`,onClick:b[14]||=e=>D.setSort(`ID`,`ASC`)},{default:f(()=>[g(n(u.$gettext(`oldest`)),1)]),_:1})]),_:1}),_(x,null,{default:f(()=>[_(W,{variant:`text`,onClick:b[15]||=e=>D.setSort(`NAME`,`ASC`)},{default:f(()=>[g(n(u.$gettext(`name`)),1)]),_:1})]),_:1}),_(x,null,{default:f(()=>[_(W,{variant:`text`,onClick:b[16]||=e=>D.setSort(`TYPE`,`ASC`)},{default:f(()=>[g(n(u.$gettext(`type`)),1)]),_:1})]),_:1}),_(x,null,{default:f(()=>[_(W,{variant:`text`,onClick:b[17]||=e=>D.setSort(`EDITOR`,`ASC`)},{default:f(()=>[g(n(u.$gettext(`editor`)),1)]),_:1})]),_:1})]),_:1})]),_:1})])])]),_(S,{class:`items`},{default:f(()=>[(t(!0),c(p,null,r(E.items,(r,o)=>(t(),d(x,{key:o},{default:f(()=>[m(`div`,be,[_(Q,{"model-value":E.checked.has(r.id),"onUpdate:modelValue":e=>D.toggleCheck(r),class:a([{draft:!r.published},`item-check`])},null,8,[`model-value`,`onUpdate:modelValue`,`class`]),m(`span`,xe,[(t(),d(i(u.$vuetify.display.xs?`v-dialog`:`v-menu`),{"aria-label":u.$gettext(`Actions`),modelValue:E.menu[o],"onUpdate:modelValue":e=>E.menu[o]=e,transition:`scale-transition`,location:`end center`,"max-width":`300`},{activator:f(({props:t})=>[_(W,e({ref_for:!0},t,{title:u.$gettext(`Actions`),icon:T.mdiDotsVertical,variant:`text`}),null,16,[`title`,`icon`])]),default:f(()=>[_(G,null,{default:f(()=>[_(Y,{density:`compact`},{default:f(()=>[_(q,null,{default:f(()=>[g(n(u.$gettext(`Actions`)),1)]),_:1}),_(W,{icon:T.mdiClose,"aria-label":u.$gettext(`Close`),onClick:e=>E.menu[o]=!1},null,8,[`icon`,`aria-label`,`onClick`])]),_:2},1024),_(S,{onClick:e=>E.menu[o]=!1},{default:f(()=>[h(_(x,null,{default:f(()=>[_(W,{"prepend-icon":T.mdiPublish,variant:`text`,onClick:e=>D.publish(r)},{default:f(()=>[g(n(u.$gettext(`Publish`)),1)]),_:1},8,[`prepend-icon`,`onClick`])]),_:2},1536),[[y,!r.deleted_at&&!r.published&&this.user.can(`element:publish`)]]),!r.deleted_at&&this.user.can(`element:drop`)?(t(),d(x,{key:0},{default:f(()=>[_(W,{"prepend-icon":T.mdiDelete,variant:`text`,onClick:e=>D.drop(r)},{default:f(()=>[g(n(u.$gettext(`Delete`)),1)]),_:1},8,[`prepend-icon`,`onClick`])]),_:2},1024)):l(``,!0),r.deleted_at&&this.user.can(`element:keep`)?(t(),d(x,{key:1},{default:f(()=>[_(W,{"prepend-icon":T.mdiDeleteRestore,variant:`text`,onClick:e=>D.keep(r)},{default:f(()=>[g(n(u.$gettext(`Restore`)),1)]),_:1},8,[`prepend-icon`,`onClick`])]),_:2},1024)):l(``,!0),this.user.can(`element:purge`)?(t(),d(x,{key:2},{default:f(()=>[_(W,{"prepend-icon":T.mdiDeleteForever,variant:`text`,onClick:e=>D.purge(r)},{default:f(()=>[g(n(u.$gettext(`Purge`)),1)]),_:1},8,[`prepend-icon`,`onClick`])]),_:2},1024)):l(``,!0)]),_:2},1032,[`onClick`])]),_:2},1024)]),_:2},1032,[`aria-label`,`modelValue`,`onUpdate:modelValue`]))])]),m(`a`,{href:`#`,class:a([`item-content`,{trashed:r.deleted_at}]),onClick:v(e=>u.$emit(`select`,r),[`prevent`]),title:D.title(r)},[m(`div`,Ce,[m(`div`,we,[r.lang?(t(),c(`span`,Te,n(r.lang),1)):l(``,!0),r.publish_at?(t(),d(C,{key:1,class:`publish-at`,icon:T.mdiClockOutline},null,8,[`icon`])):l(``,!0),m(`span`,Ee,n(r.name||u.$gettext(`New`)),1)]),m(`div`,De,n(r.type),1)]),m(`div`,$,[m(`div`,Oe,n(r.editor),1),m(`div`,ke,n(new Date(r.updated_at).toLocaleString()),1)])],10,Se)]),_:2},1024))),128))]),_:1}),E.loading?(t(),c(`p`,Ae,[g(n(u.$gettext(`Loading`))+` `,1),b[24]||=m(`svg`,{class:`spinner`,width:`32`,height:`32`,fill:`currentColor`,viewBox:`0 0 24 24`,xmlns:`http://www.w3.org/2000/svg`},[m(`circle`,{class:`spin1`,cx:`4`,cy:`12`,r:`3`}),m(`circle`,{class:`spin1 spin2`,cx:`12`,cy:`12`,r:`3`}),m(`circle`,{class:`spin1 spin3`,cx:`20`,cy:`12`,r:`3`})],-1)])):l(``,!0),!E.loading&&!E.items.length?(t(),c(`p`,je,n(u.$gettext(`No entries found`)),1)):l(``,!0),E.last>1?(t(),d(ie,{key:2,modelValue:E.page,"onUpdate:modelValue":b[18]||=e=>E.page=e,length:E.last},null,8,[`modelValue`,`length`])):l(``,!0),!this.embed&&this.user.can(`element:add`)?(t(),c(`div`,Me,[_(W,{onClick:b[19]||=e=>E.vschemas=!0,title:u.$gettext(`Add element`),disabled:E.loading,icon:T.mdiPlus,class:`btn-add`,color:`primary`,variant:`tonal`},null,8,[`title`,`disabled`,`icon`])])):l(``,!0),(t(),d(s,{to:`body`},[_(K,{modelValue:E.vschemas,"onUpdate:modelValue":b[21]||=e=>E.vschemas=e,onAfterLeave:b[22]||=e=>E.vschemas=!1,scrollable:``,width:`auto`},{default:f(()=>[_(G,null,{default:f(()=>[_(J,null,{default:f(()=>[_(O,{type:`content`,onAdd:b[20]||=e=>D.add(e)})]),_:1})]),_:1})]),_:1},8,[`modelValue`])])),_(k,{modelValue:E.editDialog,"onUpdate:modelValue":b[23]||=e=>E.editDialog=e,count:D.checkedCount,onApply:D.save},null,8,[`modelValue`,`count`,`onApply`])],64)}var Pe=H(pe,[[`render`,Ne],[`__scopeId`,`data-v-09c0f943`]]);export{Pe as t};