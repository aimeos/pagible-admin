import{a as g}from"./graphql-DDc0h6Gc.js";import{_ as u,b as c,a6 as p,F as f,E as w,be as _,bf as $}from"./index-1VvVC-C4.js";import{u as I}from"./utils-CD_c2qef.js";import{b as d,k as l,q as m,l as v,p as b,A as E}from"./tree-BNjmEZhO.js";const h=g`
...
`+t,"error"),this.$log("FileDetailItemVideo::uploadCover(): Error uploading video cover",t)}).finally(()=>{this.loading.cover=!1})}}},x={class:"editor-container"},F=["src"],V={key:0,class:"toolbar"},k=["src","alt"],N={key:1};function B(e,i,t,a,r,s){return d(),l("div",x,[m("video",{ref:"video",src:a.url(t.item.path),crossorigin:"anonymous",class:"element",controls:""},null,8,F),t.readonly?E("",!0):(d(),l("div",V,[Object.values(t.item.previews).length?(d(),l("img",{key:0,class:"video-preview",src:a.url(Object.values(t.item.previews).shift()),alt:t.item.name,onClick:i[0]||(i[0]=o=>s.removeCover())},null,8,k)):(d(),l("div",N,[v(c,{icon:a.mdiTooltipImage,loading:r.loading.cover,title:e.$gettext("Use as cover image"),class:"btn-cover-use",onClick:i[1]||(i[1]=o=>s.addCover())},null,8,["icon","loading","title"]),v(c,{icon:"",class:"btn-cover-upload",loading:r.loading.cover,title:e.$gettext("Upload cover image"),onClick:i[3]||(i[3]=o=>e.$refs.coverInput.click())},{default:b(()=>[v(p,{icon:a.mdiImagePlus},null,8,["icon"]),m("input",{ref:"coverInput",type:"file",class:"cover-input",onChange:i[2]||(i[2]=o=>s.uploadCover(o))},null,544)]),_:1},8,["loading","title"])]))]))])}const S=u(C,[["render",B],["__scopeId","data-v-b650ab85"]]);export{S as default};
