import{f as g}from"./graphql-CvgRNBEg.js";import{Q as u,l as c,x as p,d1 as f,dg as w,bQ as _,ch as $}from"./index-B5TNd1k_.js";import{k as I}from"./utils-D5Fs6vLJ.js";import{V as d,l,i as m,n as v,ak as E,k as x}from"./tree-BEgJ7c65.js";import"./graphql-upload-6RPwClA1.js";const h=g`
...
`+t,"error"),this.$log("FileDetailItemVideo::uploadCover(): Error uploading video cover",t)}).finally(()=>{this.loading.cover=!1})}}},b={class:"editor-container"},V=["src"],k={key:0,class:"toolbar"},F=["src","alt"],N={key:1};function B(e,i,t,a,r,s){return d(),l("div",b,[m("video",{ref:"video",src:a.url(t.item.path),crossorigin:"anonymous",class:"element",controls:""},null,8,V),t.readonly?x("",!0):(d(),l("div",k,[Object.values(t.item.previews).length?(d(),l("img",{key:0,class:"video-preview",src:a.url(Object.values(t.item.previews).shift()),alt:t.item.name,onClick:i[0]||(i[0]=o=>s.removeCover())},null,8,F)):(d(),l("div",N,[v(c,{icon:a.mdiTooltipImage,loading:r.loading.cover,title:e.$gettext("Use as cover image"),class:"btn-cover-use",onClick:i[1]||(i[1]=o=>s.addCover())},null,8,["icon","loading","title"]),v(c,{icon:"",class:"btn-cover-upload",loading:r.loading.cover,title:e.$gettext("Upload cover image"),onClick:i[3]||(i[3]=o=>e.$refs.coverInput.click())},{default:E(()=>[v(p,{icon:a.mdiImagePlus},null,8,["icon"]),m("input",{ref:"coverInput",type:"file",class:"cover-input",onChange:i[2]||(i[2]=o=>s.uploadCover(o))},null,544)]),_:1},8,["loading","title"])]))]))])}const W=u(C,[["render",B],["__scopeId","data-v-b650ab85"]]);export{W as default};
