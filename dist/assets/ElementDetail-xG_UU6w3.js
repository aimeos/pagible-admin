const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ChangesDialog-DettSUrb.js","./index-CE7sNWeg.js","./tree-CotDcuIv.js","./graphql-C9B-AmXv.js","./graphql-upload-BJJQ6Vjw.js","./index-CY4YNE30.css","./utils-CW0rDvqZ.js","./VChip-C8iOiMMV.js","./VSlideGroup-Ckc3Oil0.js","./VSlideGroup-Dco48V-a.css","./VChip-BfxGbTdl.css","./ChangesDialog-C1PZAJRP.css","./HistoryDialog-DyGtorne.js","./VCheckbox-DLXCrlAW.js","./VCheckboxBtn-BontaaTF.js","./VSelectionControl-3hxKSOYv.js","./VInput-BiqH4btN.js","./VInput-DOMR_3Gs.css","./VSelectionControl-eTkllCWw.css","./VCheckbox-DXrFno_w.css","./HistoryDialog-BvHXOeUv.css","./ai-DzrvFjOR.js","./audio-CvQuggF0.js"])))=>i.map(i=>d[i]);
import{_ as D,H as w,t as B,L as H,b_ as R,w as J,o as v,b$ as W,O as G,J as K}from"./index-CE7sNWeg.js";import{d as E}from"./graphql-C9B-AmXv.js";import{d as L,D as Q,A as X,i as Y,p as Z,j as x,k as ee,a as te,e as se,g as S,l as ie,m as T}from"./VMain-CP5_sIE9.js";import{V as N}from"./VSheet-DZXwBG8-.js";import{c as ae,V as I,a as O,b as A}from"./VExpansionPanels-B5wDufPJ.js";import{V as U}from"./VTable-CJ00uhKq.js";import{c as b,p as l,b as p,l as a,B as c,C as m,q as o,k as y,F as $,R as P,A as C,j as f,m as g,S as q,T as le,z as re,x as ne}from"./tree-CotDcuIv.js";import{F as oe}from"./Fields-C006JQiB.js";import{g as de,f as _,i as me}from"./utils-CW0rDvqZ.js";import{a as j,V}from"./VRow-DUOm4WdG.js";import{V as ue}from"./VTextField-BWhYXXDN.js";import{V as he}from"./VSelect-AbmtOyAu.js";import{cleanEcho as pe,setupEcho as fe}from"./echo-CgPUI397.js";import{V as ge}from"./VForm-C8q6wXSm.js";import"./graphql-upload-BJJQ6Vjw.js";import"./VList-B8VJB0Y-.js";import"./VDivider-8FjftUHV.js";import"./VDatePicker-zyUElKRv.js";import"./VPicker-C8pz5BBH.js";import"./VSlideGroup-Ckc3Oil0.js";import"./autofocus-rwsk-I-j.js";import"./VInput-BiqH4btN.js";import"./VCheckboxBtn-BontaaTF.js";import"./VSelectionControl-3hxKSOYv.js";import"./VChip-C8iOiMMV.js";const ye=E`
  query ($id: ID!) {
    element(id: $id) {
      id
      bypages {
...
`,Oe={components:{AsideMeta:X,ChangesDialog:De,DetailAppBar:Q,HistoryDialog:we,ElementDetailRefs:ce,ElementDetailItem:$e},props:{item:{type:Object,required:!0}},provide(){return{write:this.writeText,translate:this.translateText}},data:()=>({assets:{},changed:null,destroyed:!1,dirty:!1,echoCleanup:null,echoPromise:null,error:!1,latestId:null,publishAt:null,publishTime:null,publishing:!1,saving:!1,vchanged:!1,vhistory:!1,tab:"element"}),setup(){const e=W(),t=G(),s=K(),i=R(),u=w();return{dirtyStore:e,side:i,user:u,messages:s,viewStack:t}},created(){this.dirtyStore.register(()=>this.save(!0)),!(!this.item?.id||!this.user.can("element:view"))&&this.$apollo.query({query:Se,fetchPolicy:"no-cache",variables:{id:this.item.id}}).then(e=>{if(e.errors||!e.data.element)throw e;const t=[],s={},i=e.data.element;this.reset(),this.latestId=i.latest?.id;for(const u of i.latest?.files||i.files||[])s[u.id]=Object.freeze({...u,previews:_(u.previews)}),t.push(u.id);this.assets=g(s),this.item.files=t,fe(this,"element",this.item.id,u=>{!this.dirty&&this.user.can("element:view")&&u.editor!==this.user.me?.email&&(this.latestId=u.versionId,Object.assign(this.item,u.data))})}).catch(e=>{this.messages.add(this.$gettext("Error fetching element")+`:
